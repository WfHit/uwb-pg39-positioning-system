 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
 ...
 #else 
  #define HSE_VALUE    ((uint32_t)16000000) /*!< Value of the External oscillator in Hz */  //8000000
 #endif /* STM32F10X_CL */
#endif /* HSE_VALUE */
 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value 
   */
#define HSE_STARTUP_TIMEOUT   ((uint16_t)0xFFFF) /*!< Time out for HSE start up */  //0x0500
...
#define USBD_RAM_BASE         (APB1PERIPH_BASE + 0x6000)
